...
//        onMoveShouldSetPanResponderCapture: (evt, gestureState) => true,
    ...
    render() {
        return <View style={[{height: Dimensions.get('window').height}, this.props.style]} onLayout={e => this.containerLayout = e.nativeEvent.layout} {...this._panResponder.panHandlers}>
          {this.props.children}
